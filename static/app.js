  ...
  const FILTERS_BY_CAT = {
    power_bank: COMMON_FILTERS.concat([
      ...
      { key: "mahMax", label: "Max mAh", type: "num",
        test: (p, v) => { v = parseFloat(v) || 0; return !v || (p.claimed_mah || 0) <= v; } },
      { key: "maxWeightG", label: "Max weight (g)", type: "num",
        test: (p, v) => { v = parseFloat(v) || 0; return !v || !p.weight_g || p.weight_g <= v; } },
    ...
    power_station: COMMON_FILTERS.concat([
      ...
      { key: "maxWeightKg", label: "Max weight (kg)", type: "num",
        test: (p, v) => { v = parseFloat(v) || 0; return !v || !p.weight_g || (p.weight_g / 1000) <= v; } },
